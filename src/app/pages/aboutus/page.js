                        ...
                        <div className="col-xl-6 col-xxl-4" >
                            <div className="counter-content">
                                <div className="th-counterup style2 wow fadeInUp">
                                    <div className="inner">
                                        <div className="icon">
                                           <img src="/img/icon/counter_2_1.svg" alt="not found" />
                                        </div>
                                ...
                                <div className="th-counterup style2 wow fadeInUp">
                                    <div className="inner">
                                        <div className="icon">
                                           <img src="/img/icon/counter_2_2.svg" alt="not found" />
                                        </div>
                                        <div className="content">
                                            <h3 className="counter">
                                ...
                                <div className="th-counterup style2 wow fadeInUp">
                                    <div className="inner">
                                        <div className="icon">
                                           <img src="/img/icon/counter_2_3.svg" alt="not found" />
                                        </div>
                                        <div className="content">
                                            <h3 className="counter">
                                ...
                                <div className="th-counterup style2 wow fadeInUp">
                                    <div className="inner">
                                        <div className="icon">
                                           <img src="/img/icon/counter_2_4.svg" alt="not found" />
                                        </div>
                                        <div className="content">
                                            <h3 className="counter">
