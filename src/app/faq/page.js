export default function Faq() {
  return (
    <div className="p-4 container mx-auto">
      {/* Section Title */}
      <h1 className="text-4xl font-bold text-center text-warning mb-6">Frequently Asked Questions</h1>
      ...
      <div className="max-w-2xl mx-auto bg-white p-5 shadow-lg rounded-lg">
        <ul className="space-y-6">
          ...
          <li className="border-b pb-4">
            <h3 className="text-xl font-semibold text-warning">What is this website?</h3>
          ...
          {/* FAQ Item 2 */}
          <li className="border-b pb-4">
            <h3 className="text-xl font-semibold text-warning">What is Tailwind CSS?</h3>
            <p className="text-gray-600 mt-2">
          ...
          {/* FAQ Item 3 */}
          <li>
            <h3 className="text-xl font-semibold text-warning">What is Next.js?</h3>
            <p className="text-gray-600 mt-2">
